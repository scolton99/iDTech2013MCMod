...
public class WorldGenTrees extends WorldGenerator
{
    ...
    private final boolean lapisTreesFin;
    ...
    public WorldGenTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        ...
        this.metaWood = par3;
        this.lapisTreesFin = false;
        this.metaLeaves = par4;
        this.vinesGrow = par5;
    }

    public WorldGenTrees(boolean par1, int par2, int par3, int par4, boolean par5, boolean lapisTrees)
    {
        super(par1);
        this.minTreeHeight = par2;
        if(lapisTrees){
        	this.lapisTreesFin = true;
        	this.metaLeaves = 0;
        	this.metaWood = 2;
        }else{
        	this.lapisTreesFin = false;
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + var6 + 1 <= 256)
        {
                ...
                for (int var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
                {
                    for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var12 != 0 && var12 != Block.leaves.blockID && var12 != Block.grass.blockID && var12 != Block.dirt.blockID && var12 != Block.wood.blockID && var12 != Block.blockLapis.blockID && var12 != mod_LapisTools.leavesLapis.blockID)
                            {
                                var7 = false;
                            }
                        }
            ...
            else
            {
                ...
                {
                	BiomeGenBase var27 = par1World.getBiomeGenForCoords(par3, par5);
                	if(var8 != Block.blockLapis.blockID){
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                if (Math.abs(var15) != var13 || Math.abs(var17) != var13 || par2Random.nextInt(2) != 0 && var12 != 0)
                                {
                                    ...
                                    if (var18 == 0 || var18 == Block.leaves.blockID || var18 == mod_LapisTools.leavesLapis.blockID)
                                    {
                                    	if(this.lapisTreesFin){
                                    		this.setBlockAndMetadata(par1World, var14, var11, var16, mod_LapisTools.leavesLapis.blockID, 0);
                                    	}else{
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        if (var12 == 0 || var12 == Block.leaves.blockID || var12 == mod_LapisTools.leavesLapis.blockID)
                        {
