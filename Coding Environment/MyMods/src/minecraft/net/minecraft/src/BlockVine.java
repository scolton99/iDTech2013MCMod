...
public class BlockVine extends Block
{
    ...
    public BlockVine(int par1, boolean isLapis)
    {
        super(par1, Material.vine);
        this.setTickRandomly(true);
        this.setCreativeTab(CreativeTabs.tabDecorations);
        this.isLapis = isLapis;
    }
    ...
    {
        return isLapis ? 0x0000ff : ColorizerFoliage.getFoliageColorBasic();
    }
    ...
    {
        return isLapis ? 0x0000ff : par1IBlockAccess.getBiomeGenForCoords(par2, par4).getBiomeFoliageColor();
    }
