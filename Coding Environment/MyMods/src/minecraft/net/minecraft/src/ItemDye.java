...
public class ItemDye extends Item
{
	...
	public static boolean func_96604_a(ItemStack par0ItemStack, World par1World, int par2, int par3, int par4)
	{
		...
		if (var5 == Block.sapling.blockID || var5 == mod_LapisTools.saplingLapis.blockID)
		{
			if (!par1World.isRemote)
			{
				if ((double)par1World.rand.nextFloat() < 0.45D)
				{
					if(var5 == mod_LapisTools.saplingLapis.blockID){
						((BlockSapling)mod_LapisTools.saplingLapis).markOrGrowMarked(par1World, par2, par3, par4, par1World.rand);
					}else{
