...
public abstract class Minecraft implements Runnable, IPlayerUsage {
   ...
   private final ILogAgent field_94139_O = new LogAgent("Minecraft-Client", " [CLIENT]", (new File(func_71380_b(), "output-client.log")).getAbsolutePath());
   ...
   public void func_71384_a() throws LWJGLException {
      ...
      this.func_71357_I();
      Mouse.create();
      this.field_71417_B = new MouseHelper(this.field_71447_l, this.field_71474_y);
   ...
   public static File func_71394_a(String p_71394_0_) {
      ...
      File var2;
      switch(EnumOSHelper.field_90049_a[func_71376_c().ordinal()]) {
      case 1:
      case 2:
      ...
      if(this.field_71462_r != null) {
         ...
         if(this.field_71462_r != null) {
            ...
            try {
               ...
               var3 = var2.func_85058_a("Affected screen");
               var3.func_71500_a("Screen name", new CallableTickingScreenName(this));
               throw new ReportedException(var2);
            }
         }
      }
      ...
      if(this.field_71462_r == null || this.field_71462_r.field_73885_j) {
         ...
         while(Mouse.next()) {
            ...
            if(var1 <= 200L) {
               ...
               if(var10 != 0) {
                  this.field_71439_g.field_71071_by.func_70453_c(var10);
                  if(this.field_71474_y.field_74331_S) {
                     ...
                     this.field_71474_y.field_74328_V += (float)var10 * 0.25F;
                  }
               }
               ...
               if(Keyboard.getEventKey() == 87) {
                  ...
                  for(var9 = 0; var9 < 9; ++var9) {
                     if(Keyboard.getEventKey() == 2 + var9) {
                        this.field_71439_g.field_71071_by.field_70461_c = var9;
                     }
                  }
   ...
   public void func_71360_a(String p_71360_1_, File p_71360_2_) {
      ...
      if(var4.equalsIgnoreCase("sound3")) {
         ...
         if(var4.equalsIgnoreCase("lang")) {
            StringTranslate.func_74808_a().func_94519_a(p_71360_1_, p_71360_2_);
         }
      } else {
   ...
   public static void main(String[] p_main_0_) {
      ...
      for(int var9 = 2; var9 < p_main_0_.length; ++var9) {
         ...
         if(!var10.equals("-demo") && !var10.equals("--demo")) {
            if(var10.equals("--applet")) {
               ...
               String[] var13 = HttpUtil.func_82718_a((ILogAgent)null, var6, var11);
               if(var13 != null) {
                  var6 = var13[0];
                  var7 = var13[1];
      ...
      while(var19.hasNext()) {
         ...
         func_71410_x().func_98033_al().func_98233_a(var14);
      }
   ...
   public CrashReport func_71396_d(CrashReport p_71396_1_) {
      ...
      p_71396_1_.func_85056_g().func_71500_a("Texture Pack", new CallableTexturePack(this));
      p_71396_1_.func_85056_g().func_71500_a("Profiler Position", new CallableClientProfiler(this));
      p_71396_1_.func_85056_g().func_71500_a("Vec3 Pool Size", new CallableClientMemoryStats(this));
      if(this.field_71441_e != null) {
